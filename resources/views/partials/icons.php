<?php
/**
 * Inline SVG sprite. Referenced through icon('name') — the UI uses icons only.
 * Paths are 24x24, stroke-based (Feather/Lucide geometry).
 */
?>
<svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true">
    <defs>
        ...
        $icons = [
            ...
            'files'      => '<path d="M15.5 2H8.6c-.4 0-.8.2-1.1.5-.3.3-.5.7-.5 1.1v12.8c0 .4.2.8.5 1.1.3.3.7.5 1.1.5h9.8c.4 0 .8-.2 1.1-.5.3-.3.5-.7.5-1.1V6.5z"/><path d="M3 7.6v12.8c0 .4.2.8.5 1.1.3.3.7.5 1.1.5h9.8"/><path d="M15 2v5h5"/>',
            ...
            'upload-cloud' => '<path d="M16 16l-4-4-4 4"/><path d="M12 12v9"/><path d="M20.4 18.4A5 5 0 0 0 18 9h-1.3A8 8 0 1 0 3 16.3"/>',
            ...
            'link-off'   => '<path d="M18.36 6.64a9 9 0 0 1 1.05 11.32"/><path d="M6.64 6.64a9 9 0 0 0 1.05 11.32"/><line x1="2" y1="2" x2="22" y2="22"/>',
            ...
            'webhook'    => '<path d="M18 16.98h-5.99c-1.1 0-1.95.94-2.48 1.9A4 4 0 0 1 2 17c.01-.7.2-1.4.57-2"/><path d="M6 17l3.13-5.78c.53-.97.1-2.18-.5-3.1a4 4 0 1 1 6.89-4.06"/><path d="M12 6l3.13 5.73C15.66 12.7 16.9 13 18 13a4 4 0 0 1 0 8"/>',
        ...
        foreach ($icons as $name => $body) {
            echo '<symbol id="i-' . $name . '" viewBox="0 0 24 24">' . $body . '</symbol>' . "\n";
        }
        ?>
    </defs>
</svg>
